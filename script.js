const tarotCards = [
  { name: "愚者", upright: "新しい始まり。自由な発想で一歩踏み出して。今のあなたは、まだ白紙の地図を手にしている段階です。
...
このカードは、「今のあなたなら、転んでも立ち上がれる」と伝えています。", reversed: "無計画さに注意。勢いだけで進まないこと。本来の自由さが、今は「軽率さ」や「現実逃避」に傾いているかもしれません。
